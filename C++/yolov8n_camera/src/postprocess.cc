...
static int process(int8_t* input, int grid_h, int grid_w, int height, int width, int stride, vector<float>& boxes, vector<float>& objProbs,
    vector<int>& classId, float threshold, int32_t zp, float scale)
{
    int validCount = 0;
    ...
    float scale_w, float scale_h, vector<int32_t>& qnt_zps, vector<float>& qnt_scales, detect_result_group_t* group)
{
    ...
    int validCount0 = 0;
    validCount0 = process(input0, grid_h0, grid_w0, model_in_h, model_in_w, stride0, filterBoxes, objProbs, classId, conf_threshold,
    ...
    int validCount1 = 0;
    validCount1 = process(input1, grid_h1, grid_w1, model_in_h, model_in_w, stride1, filterBoxes, objProbs, classId, conf_threshold,
    ...
    int validCount2 = 0;
    validCount2 = process(input2, grid_h2, grid_w2, model_in_h, model_in_w, stride2, filterBoxes, objProbs, classId, conf_threshold,
